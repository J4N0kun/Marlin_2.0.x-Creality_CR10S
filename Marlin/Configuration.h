...
#define STRING_CONFIG_H_AUTHOR "(janokun, CR-10S)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EFB //BOARD_RAMPS_CREALITY
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "janokun's CR-10S"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Stock Bed Tuned for 60C
  #define DEFAULT_bedKp 155.68
  #define DEFAULT_bedKi  16.53
  #define DEFAULT_bedKd 977.71
  ...
  #define PID_FUNCTIONAL_RANGE 20 //10 If the temperature difference between the target temperature and the actual temperature
 ...
 */
#define BLTOUCH
#define SERVO0_PIN 11 //pas necessaire depuis marlin 2.0.x a priori
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -64, -2, 0 }
...
//
#define ENCODER_PULSES_PER_STEP 4 //1

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 //5
